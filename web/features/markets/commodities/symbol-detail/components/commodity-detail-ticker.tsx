...
export function CommodityDetailTickerStrip({ assets, activeSymbol }: Props) {
  ...
  return (
    <nav className="cdr-live-ticker" aria-label="Emtia canlı piyasa şeridi" data-marquee={marquee || undefined}>
