...
function FlowCol({
  ...
  return (
    <div className="cc-intel-col fc-intel-col">
            ...
            <li key={`${title}-${row.pair}`}>
              ...
              >
                ...
                {mode === "volume" && row.volume ? (
                  ...
                  <span className={cn("cc-intel-row-val", changeClass(row.changePct))}>
...
export function ForexIntelDeck({ movers }: Props) {
  const cols = [
  ...
  return (
    <section className="cc-section cc-intel-board fc-intel-board" role="region" aria-label="Forex piyasa istihbaratı">
      <div className="cc-zone-label cc-zone-label--flush">
        Piyasa istihbaratı
        <span className="cc-intel-board-sub">Parite akış özeti</span>
      </div>
