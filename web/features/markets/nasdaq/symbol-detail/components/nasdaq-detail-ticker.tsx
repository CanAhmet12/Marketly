...
import {
  mapNasdaqAssetsToTickers,
  type NasdaqTickerItem,
...
export function NasdaqDetailTickerStrip({ assets, activeSymbol }: Props) {
  ...
  return (
    <nav className="cdr-live-ticker" aria-label="NASDAQ canlı piyasa şeridi" data-marquee={marquee || undefined}>
