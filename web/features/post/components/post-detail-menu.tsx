...
export function PostDetailMenu({ post, className, onShare }: Props) {
  ...
  return (
    <div className={cn("pd-post-menu", className)} ref={rootRef}>
      <button
        type="button"
        className="pd-post-menu__btn"
      ...
      {hint ? <span className="pd-post-menu__hint">{hint}</span> : null}

      {open ? (
        <div className="pd-post-menu__popover" role="menu">
          <button
            type="button"
            role="menuitem"
            className="pd-post-menu__item"
