...
export const queryKeys = {
  ...
  creatorsDirectory: (viewerKey: string | null | undefined, sort = "recommended") =>
    ["creators-directory", viewerKey ?? "anon", sort] as const,
  ...
  signalsDiscoverPreview: () => ["signals-discover-preview"] as const,
  signalsArchiveCount: () => ["signals-archive-count"] as const,
  signalsEngagement: () => ["signals-engagement"] as const,
  signalDetail: (signalId: string, viewerKey: string) => ["signal-detail", signalId, viewerKey] as const,
  signalThreadPack: (signalId: string) => ["signal-thread-pack", signalId] as const,
  ...
  assetSymbolCommunity: (symbol: string) => ["asset-symbol-community", symbol.toUpperCase()] as const,
  cryptoSentimentAggregate: (symbol: string) => ["crypto-sentiment-aggregate", symbol.toUpperCase()] as const,
